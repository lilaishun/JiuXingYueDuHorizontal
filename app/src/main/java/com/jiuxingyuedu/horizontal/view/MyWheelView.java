...
import com.jiuxingyuedu.horizontal.Util.SizeConvertUtil;
...
public class MyWheelView extends View {
    ...
    private void init(Context context) {
        ...
        //设置画笔颜色
        selectPaint.setColor(ContextCompat.getColor(mContext, android.R.color.background_dark));
        //设置文字大小
        ...
        //设置画笔颜色
        unSelectPaint.setColor(ContextCompat.getColor(mContext, android.R.color.background_dark));
        //设置文字大小
