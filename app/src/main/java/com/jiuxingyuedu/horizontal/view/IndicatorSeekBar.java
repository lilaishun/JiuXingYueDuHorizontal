...
public class IndicatorSeekBar   extends AppCompatSeekBar {
    ...
    // 滑块按钮宽度
    private int mThumbWidth = dp2px(90);
    // 进度指示器宽度
    private int mIndicatorWidth = dp2px(70);
    // 进度监听
    ...
    protected synchronized void onDraw(Canvas canvas) {
       ...
       // String progressText = getProgress() + "%";
        String progressText = getProgress() +"/"+getMax();
        ...
        System.out.println("thumbOffset===="+thumbOffset);
        System.out.println("progressRatio======="+progressRatio);
