...
public class ZiXuFragment extends LazyFragment {
...
private ArrayList<NewsNean> NewsList=new ArrayList();
    ...
    public static ZiXuFragment newInstance(int tabIndex, boolean isLazyLoad) {

        Bundle args = new Bundle();
        args.putInt(INTENT_INT_INDEX, tabIndex);
        args.putBoolean(LazyFragment.INTENT_BOOLEAN_LAZYLOAD, isLazyLoad);
        ZiXuFragment fragment = new ZiXuFragment();
            ...
            //    Selection.setSelection((Spannable)s, s.toString().length());
              //  if(!"".equals(s.toString())) {
                if(ISSHOWSEACHER){
                    ...
                    setSeacher(s.toString(), NewsNeanList);
                }
    ...
    private void setSeacher(String s, final List<NewsNean> newsNeanLists) {
        ...
        mActivity.hlv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                System.out.println("name=============+zixu===="+objects.size());
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    Collections.sort(NewsNeanList, pinyinComparator);
                    setStateFr(NewsNeanList,0);
                    setAdapterList(NewsNeanList);
                    break;
                case 2:
